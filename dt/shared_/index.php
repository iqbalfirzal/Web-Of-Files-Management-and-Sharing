<?php
	$title = "Files For Free Download";
	$ignore_file_list = array( ".htaccess", "Thumbs.db", ".DS_Store", "index.php", "dnldprcss.php" );
...
function display_block( $file )
{
	...
	$rtn = "<div class=\"block\">";
	$rtn .= "<a href=\"dnldprcss?file=$file\" class=\"$file_ext\"{$download_att}>";
...
<div style="padding: 10px 10px 40px 10px;"><a href="http://filetoshare.pe.hu">Free Data File Host</a> | <a href="http://megonodev.ga/tel">Official Website</a></div>
</body>
</html>
