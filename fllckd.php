...
$fl = $_GET['file'];
$ow = $_GET['owner'];
$filenya = base64_decode($fl);
$ownernya = str_replace('_', ' ', $ow);
?>
<html>
<head>
<title>File Locked | Free Data File Host</title>
<meta charset="UTF-8">
...
<header class="w3-container w3-padding-32 w3-center w3-opacity w3-margin-bottom">
  ...
  <h1><b>Maaf, File Yang Anda Minta Tidak Dapat Dibuka</b></h1>
  <p><b><?php print "$ownernya"; ?> mengatur hak akses <?php print "$filenya"; ?>  hanya untuk dirinya</b></p>
